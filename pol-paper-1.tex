...
\begingroup
\begin{table}
\caption{\label{tableVelError}(Color online) Systematic error budget for measurements of $v_0$ and $r$. Parameters $w_1$, $w_2$, and $w_{det}$ are the widths of collimating slits 1 and 2 and the detector. $a_{ci}$ is the width of phase chopper $i$, and $z_{c1,c2}$ is the longitudinal distance between choppers.}
\begin{center}
\begin{tabular}{l c c}
\hline\hline
Error Source & $\delta v_0/v_0 \times 1000$ & $\delta r/r \times 1000$ \\
\hline
$w_1 = (30 \pm 6) \mu\mathrm{m}$ 		& 0.05 & 1.0 \\
$w_2 = (40 \pm 6) \mu\mathrm{m}$ 		& 0.09 & 6.6 \\
$w_{det} = (100 \pm 20) \mu\mathrm{m}$ 		& 0.05 & 4.2 \\
$\Delta x_{det} = (0 \pm 30) \mu\mathrm{m}$ 		& 0.006 & 0.15 \\
...
$\Delta L = (0 \pm 25) \mu\mathrm{m}$ 		& 0.16 \\
\hline
...
\includegraphics[width=0.49\linewidth,keepaspectratio,valign=t]{displayCsMisc.pdf}
\includegraphics[width=0.49\linewidth,keepaspectratio,valign=t]{displayMiscLegend.pdf}
